...
namespace QuanLyDoanKham.API.Migrations
{
    ...
    [Migration("20260223145939_AddAvatarPathToUserAndStaff")]
    partial class AddAvatarPathToUserAndStaff
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuanLyDoanKham.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$RJlYff2jsFp7MjA0IpoUk.pGdv3JgzIjKlyt5MXRQ7HFFIKWjEE1a",
                            RoleId = 1,
                            Username = "admin"
                        });
                });
