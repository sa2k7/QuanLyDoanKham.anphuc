...
namespace QuanLyDoanKham.API.Migrations
{
    ...
    [Migration("20260211155038_AddPatientAndExamResult")]
    partial class AddPatientAndExamResult
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuanLyDoanKham.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$TWJ3KsRpcT0mtb8ycfHnPOd9w4um6CvjPA5F0AgJTyJvtQln3Y8hC",
                            RoleId = 1,
                            Username = "admin"
                        });
                });
