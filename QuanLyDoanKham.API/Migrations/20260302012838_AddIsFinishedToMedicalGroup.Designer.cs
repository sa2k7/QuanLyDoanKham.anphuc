...
namespace QuanLyDoanKham.API.Migrations
{
    ...
    [Migration("20260302012838_AddIsFinishedToMedicalGroup")]
    partial class AddIsFinishedToMedicalGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyDoanKham.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$NnTns2sgNNcajrqlsiF9AuaCsRYfL2h70aVN9B8HvynGEQ6HvLeMq",
                            RoleId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("QuanLyDoanKham.API.Models.ExamResult", b =>
                {
                    b.HasOne("QuanLyDoanKham.API.Models.Staff", "DoctorStaff")
                        .WithMany()
                        .HasForeignKey("DoctorStaffId");

                    b.HasOne("QuanLyDoanKham.API.Models.MedicalGroup", "Group")
                        .WithMany()
