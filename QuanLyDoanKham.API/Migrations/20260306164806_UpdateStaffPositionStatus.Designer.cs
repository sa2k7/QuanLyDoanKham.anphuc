...
namespace QuanLyDoanKham.API.Migrations
{
    ...
    [Migration("20260306164806_UpdateStaffPositionStatus")]
    partial class UpdateStaffPositionStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuanLyDoanKham.API.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$uCQogxsA97UIcCvj5jrD6u51qfAoZYU711sZgYs0aCqEFb8Mr6m7K",
                            RoleId = 1,
                            Username = "admin"
                        });
                });
