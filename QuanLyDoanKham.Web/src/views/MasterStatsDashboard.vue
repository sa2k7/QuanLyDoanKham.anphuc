      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 p-6">
        <div>
          <h2 class="text-3xl font-bold text-slate-800 flex items-center gap-3">
            ...
            Thống Kê Tổng Hợp (Master Stats)
          </h2>
          <p class="text-slate-400 font-semibold uppercase tracking-widest text-[10px] mt-2">Tổng hợp doanh thu, chi phí và lợi nhuận thực tế toàn hệ thống.</p>
        </div>
