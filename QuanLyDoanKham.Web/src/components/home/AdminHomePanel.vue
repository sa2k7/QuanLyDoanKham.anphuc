...
const quickNavItems = computed(() => [
  ...
  authStore.hasPermission('DoanKham.View') ? { id: 'patients',          name: 'Bệnh án',     desc: 'Hồ sơ',        icon: UserRound,   bgClass: 'bg-blue-50',    borderClass: 'border-blue-100',    iconBg: 'bg-blue-100',    iconColor: 'text-blue-600' } : null,
